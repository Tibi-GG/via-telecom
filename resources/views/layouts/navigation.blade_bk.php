<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 fixed-top" style="padding-top:10px" >
              ...
              <title>{{ config('app.name', 'VIA TELECOM') }}</title>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('home')" :active="request()->routeIs('home')" style="text-decoration: none;">
                        ...
                        <x-nav-link :href="route('services')" :active="request()->routeIs('services')" style="text-decoration: none;">
                            {{ __('VoIP') }}
                        </x-nav-link>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                                    ...
                                    <x-slot name="content">
                                        <x-dropdown-link :href="route('voip')" :active="request()->routeIs('voip')" style="text-decoration: none;">
                                            {{ __('Broadband') }}
                                        </x-dropdown-link>
                                        <x-dropdown-link :href="route('voip')" :active="request()->routeIs('voip')" style="text-decoration: none;">
                                            {{ __('Phones and SIMs') }}
